    ...
    */
    ...
    'custom' => [
        ...
        'jenis_kelamin' => [
            ...
            'in' => 'kolom jenis kelamin harus diisi',
        ],
        'tanggal_lahir' => [
            'required' => 'kolom Tanggal Lahir harus diisi',
            'date' => 'kolom Tanggal Lahir harus diisi format yang benar',
        ],
        'id_kelas' => [
        ...
        'foto' => [
            ...
            'mimes' => 'kolom Hanya boleh diisi file *.jpg, *.jpeg, *.png',
        ],
        'nama_kelas'=> [
        ...
        'password'=> [
            ...
            'min' => 'password maksimal 6 karakter',
